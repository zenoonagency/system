        ...
        <div className="space-y-6">
          {contract.description && (
            <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
              ...
              <p className="text-gray-900 dark:text-gray-100">{contract.description}</p>
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
              ...
              <p className="text-gray-900 dark:text-gray-100">{contract.clientName}</p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
              ...
              <p className="text-gray-900 dark:text-gray-100">{formatCurrency(contract.value)}</p>
            </div>
