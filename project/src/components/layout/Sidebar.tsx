  ...
  return (
    <div className={`relative h-screen ${collapsed ? 'w-20' : 'w-64'} bg-white dark:bg-dark-800 border-r border-gray-200 dark:border-dark-700 transition-all duration-300 flex flex-col`}>
      ...
      <nav className="flex-1 mt-4">
        ...
        <SidebarLink to="/dashboard/clients" icon={<Trello size={20} />} label="Gestão de funil" collapsed={collapsed} />
        ...
        <SidebarLink to="/dashboard/plans" icon={<CreditCard size={20} />} label="Planos" collapsed={collapsed} />
